...
public class ThornView extends GraphicalObject {
    ...
    public ThornView(Thorn thorn) {
        ...
        this.dbgSpeed = (int) Math.sqrt(velocity.x * velocity.x + velocity.y
                * velocity.y);
    }
    ...
    public void draw(Graphics2D graphicsContext, double xScale, double yScale) {
        ...
        Rectangle2D rect = (Rectangle2D) this.thorn.getBoundaryRect().clone();
        ...
        Point velocityVector = this.thorn.getVelocityVector();

        int squareCenterX = (int) this.thorn.getBoundaryRect().getCenterX();
        int squareCenterY = (int) this.thorn.getBoundaryRect().getCenterY();
        ...
        graphicsContext.drawString(Integer.toString(this.dbgSpeed),
